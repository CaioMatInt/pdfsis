            ...
            <div class="box box-main-custom">
                <div class="box-body">
                    @if(session('msg'))
                        ...
                        @endcomponent
                    @endif
                    <form action="{{ route('clients.update', $contracts) }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('requiriments') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="requiriments" id="requiriments" value="{{ old('requiriments', $contracts->requiriments) }}">
                        ...
                        <div class="form-group {{ $errors->has('object') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="object" id="object" value="{{ old('object', $contracts->object) }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description" value="{{ old('description', $contracts->description) }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('exceptions') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="exceptions" id="exceptions" value="{{ old('exceptions', $contracts->exceptions) }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('additional') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="additional" id="additional" value="{{ old('additional', $contracts->additional) }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('team') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="team" id="team" value="{{ old('team', $contracts->team) }}">
                            @if ($errors->has('team'))
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('deadline') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="deadline" id="deadline" value="{{ old('deadline', $contracts->deadline) }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('payment_options') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="payment_options" id="payment_options" value="{{ old('payment_options', $contracts->payment_options) }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('maintenance') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="maintenance" id="maintenance" value="{{ old('maintenance', $contracts->maintenance) }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('infra') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="infra" id="infra" value="{{ old('infra', $contracts->infra) }}">
                            @if ($errors->has('infra'))
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('sustentation') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="sustentation" id="sustentation" value="{{ old('sustentation', $contracts->sustentation) }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('expiration') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="expiration" id="expiration" value="{{ old('expiration', $contracts->expiration) }}">
